...
class SocketMessageManager(
    ...
    private val scope: CoroutineScope = CoroutineScope(dispatcher.io)
    ...
    private val socketConfig = connectionManager.tcpSocket.socketConfig
    ...
    suspend fun sendMessage(
        ...
        try {
            ...
            if (messageReceipt != null) {
                messagesAwaitingReceipt.put(sentMessageId, AwaitingMessage(
